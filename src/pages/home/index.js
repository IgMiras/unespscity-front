...
const Home = (props) => {
	...
	const [popup18, setPopup18] = useState(false);
			...
			<ContainerBase>
				...
				<Content>
					<WrapContainer>
						...
						<SanitarySurveillancePopUp
							trigger={popup04}
							setTrigger={setPopup04}
						/>
						...
						<PublicAdministrationPopUp
							trigger={popup14}
							setTrigger={setPopup14}
						/>
						...
						<CommercialAssociationPopUp
							trigger={popup17}
							setTrigger={setPopup17}
						/>
						<div onClick={() => setPopup18(true)}>
							<Card
								source='/assets/img/loading-bar.png'
								titulo='Testando(IgMiras)'
							/>
						</div>
					</WrapContainer>
					<GrayLine />
